...
TF1* fit_bode = new TF1("fit_bode","1/sqrt(1+pow([0]/x,2))");   //FILTRO PASSA ALTO
...
/*
TF1* fit_bode = new TF1("fit_bode","1/sqrt(1+pow(x/[0],2))");   //FILTRO PASSA BASSO
fit_bode->SetParName(0,"nu0");
fit_bode->SetParameter(0,?);

TF1* fit_fase = new TF1("fit_fase","-atan(x/[0])");
fit_fase->SetParName(0,"nu0");
fit_fase->SetParameter(0,?);
*/
